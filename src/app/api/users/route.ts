...
const API_BASE = "https://8d20848e8532dc2d.mokky.dev/karabaklist";

// GET - Бардык маалыматтарды алуу (limit=3000 менен)
export async function GET() {
	try {
		const response = await fetch(`${API_BASE}?limit=3000`, {
			cache: "no-store",
		});
